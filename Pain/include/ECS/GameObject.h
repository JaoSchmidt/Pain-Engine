...
//   {
//     return m_scene->createComponent<T>(m_entity,
...
//   // ---------------------------------------------------- //
//   template <typename... Components> std::tuple<Components &...>
//   getComponents()
//   {
//     PROFILE_FUNCTION();
...
//   {
//     PROFILE_FUNCTION();
//     return m_scene->hasAnyComponents<TargetComponents...>(m_entity,
//     m_bitmask);
//   }
//
...
//   // void rmComponents()
//   // {
//   //   m_scene->rmComponent<TargetComponets...,
//   ObjectComponents...>(m_entity);
//   // }
//
