 ...
 */
Result checkAABBCollision(const glm::vec2 &center1, const glm::vec2 &halfSize1,
...
Result checkCircleCollision(const glm::vec2 &center1, float radius1,
...
Result checkAABBCollisionOBB(const glm::vec2 &center1,
...
Result checkAABBCollisionCircle(const glm::vec2 &center1,
                                const glm::vec2 &halfSize1,
                                const glm::vec2 &center2, float radius2);
